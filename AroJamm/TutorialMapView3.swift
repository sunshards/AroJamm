...
struct TutorialMapView3: View {
    ...
    @State private var nextLocation = Target(coordinate: naplesCoordinates, nome: "Naples", imagePath: "example", category: "Culture", description: "According to ancient lore, Naples was founded by the siren Parthenope, who was said to have drowned herself in the Gulf of Naples after failing to seduce Odysseus with her song.")
        ...
        NavigationStack {
            ZStack {
                ...
                Map(position: $position) {
                    ...
                    UserAnnotation()
                        Annotation("", coordinate: naplesCoordinates) {
                            VStack {
                        ...
                        Marker("", coordinate: naplesCoordinates).tint(Color.accentColor).annotationTitles(.visible)
                ...
                VStack {
                    ...
                    Spacer()
                    VStack() {
                        Text("Tap the glowing icons to learn something about the city!")
                            .font(.title3)
